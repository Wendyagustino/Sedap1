...
export default function Notes() {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            setError(`Terjadi kesalahan saat update: ${err.message}`);
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="max-w-2xl mx-auto p-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <form onSubmit={editMode ? handleUpdate : handleSubmit} className="space-y-4">
                    <input
                        type="text"
                        name="title"
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {editMode && (
                            <button
                                ...
                                className="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold rounded-2xl transition-all duration-200"
                            >
                                Batal Edit
                            </button>
                        )}
