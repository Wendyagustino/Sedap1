    ...
    return (
        <div id="sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            <div id="sidebar-logo" className="flex flex-col">
                ...
                <span id="logo-subtitle" className="font-semibold text-gray-400Z">Modern Admin Dashboard</span>
            </div>
            ...
            <div id="sidebar-menu" className="mt-10">
                <ul id="menu-list" className="space-y-3">
                    ...
                    <li>
	                    <NavLink id="error-1" to="/error400" className={menuClass}>
                        <AiOutlineUser />
                        Error 400</NavLink>
	                </li>

                    <li>
	                    <NavLink id="error-2" to="/error401" className={menuClass}>
                        <AiOutlineUser />
                        Error 401</NavLink>
	                </li>

                    <li>
	                    <NavLink id="error-3" to="/error403" className={menuClass}>
                        <AiOutlineUser />
                        Error 403</NavLink>
	                </li>
                    <li>
